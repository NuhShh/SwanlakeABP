...
class DesktopsnLaptopPageModel extends FlutterFlowModel<DesktopsnLaptopPageWidget> with ChangeNotifier {
  List<ReviewItem> reviews = [];
  bool isLoadingReviews = false;
  String? reviewsError;

  Future<void> fetchDesktopLaptopReviews() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('http://10.0.2.2:8000/api/get/review/desktoplaptop'),
        headers: {
      ...
      if (response.statusCode == 200) {
        ...
        print('Fetched desktop/laptop reviews count: ${reviews.length}');
      } else {
  ...
  void initState(BuildContext context) {
    // Optional: fetch reviews on init
    fetchDesktopLaptopReviews();
  }
