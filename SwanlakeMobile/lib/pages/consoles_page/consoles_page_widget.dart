...
class ConsolesPageWidget extends StatefulWidget {
  const ConsolesPageWidget({super.key});

  static String routeName = 'ConsolesPage';
  static String routePath = '/consolesPage';

  @override
  State<ConsolesPageWidget> createState() => _ConsolesPageWidgetState();
}

class _ConsolesPageWidgetState extends State<ConsolesPageWidget> with TickerProviderStateMixin {
  late ConsolesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConsolesPageModel());
    _model.fetchConsoleReviews();
    setupAnimations(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        review.reviewTitle,
                                        style: FlutterFlowTheme.of(context).bodyLarge.override(fontWeight: FontWeight.w600),
                                      ),
                                      SizedBox(height: 6),
                                      Text(
                                        review.cardDesc,
